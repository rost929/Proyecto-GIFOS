...
const assignFavoriteEvent = (arrayFavoriteButtons, gifsArray, counter = 0) => {
...
const removeFavorite = (arrayFavoriteButtons) => {
  arrayFavoriteButtons.forEach((element, index) => {
    element.addEventListener("click", function () {
      const favoriteCardSelected = document.querySelector(
        "#cardGifoFav" + index
      );
...
export { assignFavoriteEvent, removeFavorite };
